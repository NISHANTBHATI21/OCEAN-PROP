...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      // For GitHub Pages, we'll use a mailto fallback
      ...
      setTimeout(() => {
        ...
        showFormMessage(messageDiv, '✅ Thank you! We will contact you shortly to schedule your call.', 'success');
        contactForm.reset();

        // Open mailto as fallback
        window.location.href = `mailto:oceanproperties2454@gmail.com?subject=${subject}&body=${body}`;
      }, 1500);
    });
  }
